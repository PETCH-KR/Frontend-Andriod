...
class CompanyInfo_CompanyReview_Fragment  : Fragment(){
    ...
    override fun onCreateView(
        ...
        var view :View = inflater.inflate(R.layout.activity_companyinfo_companyreview, container, false)
        ...
        for(i: Int in 1..10) {
            ...
            Glide.with(this).load(R.drawable.petch_pic).apply(RequestOptions().transforms(CenterCrop(), RoundedCorners(20))).into(circleView!!)
    ...
    fun newInstant() : CompanyInfo_CompanyReview_Fragment
    {
        val args = Bundle()
        val frag = CompanyInfo_CompanyReview_Fragment()
        frag.arguments = args
        return frag
    }
